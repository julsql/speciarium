...
class Species(models.Model):
    ...
    kingdom = models.CharField(max_length=255, verbose_name="Règne")
    class_field = models.CharField(max_length=255, verbose_name="Classe")
    category = models.CharField(max_length=255, verbose_name="Categorie")
